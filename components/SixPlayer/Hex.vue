<template>
    <div :class="classes" :style="{transform: translation}" :data-q="hex.q" :data-r="hex.r" @click.stop="click"
         v-on:dblclick="hi">
...
export default {
    ...
    methods: {
        ...
        hi() {
            let e = prompt("piece");
            if (e === "log") {
                console.log(useSixPlayerStore().defaultBoard)
            } else {
                getPiece(this.hex.q, this.hex.r, useSixPlayerStore().defaultBoard).p = e;
            }
        }
    },
    computed: {
        ...
        translation() {
            ...
            return `translate(calc(var(--hex-size) * ${hexSpacing + 1} * ${this.x} - var(--hex-size)), calc(var(--hex-size) * ${hexSpacing + 1} * ${this.y} - var(--hex-size)))`;
        },
        ...
        classes() {
            ...
            return {
                hex: true,
                white: this.hex.r % 2 === 0 && this.hex.q % 2 === 0,
                pink: (this.hex.r + 0) % 2 === 0 && (this.hex.q + 1) % 2 === 0,
                purple: this.hex.q % 2 === 0 && !this.hex.r % 2 === 0,
